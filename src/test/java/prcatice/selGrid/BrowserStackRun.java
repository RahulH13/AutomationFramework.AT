...
public class BrowserStackRun {
	...
	public static final String USERNAME = "username";   //username:- my username which from Browserstack
	public static final String AUTOMATE_KEY = "accessKey";   //accessKey:- my username which from Browserstack
